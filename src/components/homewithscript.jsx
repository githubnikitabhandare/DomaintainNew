        ...
        useEffect(() => {
          function handleScroll() {
            if (window.scrollY > 200) {
              ...
              document.getElementById('DM_banner_wrap').classList.remove('dm_active');
  ...
  return (
    <>
      <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="40">
        <div className={isScrolled ? 'dm_active' : ''} id="DM_banner_wrap">
        <header id="navbar_top" className={isScrolled ? 'fixed-top' : ''} >
        ...
        <section id="DMS_WhyDMS" className="position-relative">
          ...
          <img src={featureshape} alt="features-shape"
